...
public class ArrayPage {
	  public WebDriver driver;
	   ...
	   @FindBy(xpath="//a[text()='Arrays in Python']")WebElement araaysInPython;
	   @FindBy(xpath="//a[text()='Arrays Using List']") WebElement ArraysUsingList ;
	   @FindBy(xpath="//a[text()='Basic Operations in Lists']") WebElement basicOperationsInList ;
	   @FindBy(xpath="//a[text()='Applications of Array']") WebElement ApplicationsOfArrays ;
